<template>
  <div class="lg:mt-20 mt-10 lg:flex lg:justify-between">
    <div class="flex">
      ...
      <div class="my-auto">
        <p class="lg:text-7xl text-5xl text-white">{{ data.name }}</p>
        <p class="text-white/90 mt-3 lg:text-3xl text-xl">
          {{ getWeatherDescription(data.current.weather[0].id) }}
        </p>
      </div>
    </div>
    ...
    <div class="bg-white/20 rounded-xl h-48 grid items-center">
      <div class="">
        ...
        <div class="text-center mt-3">
          ...
          <p class="text-white text-xl">{{ Math.round(data.current.feels_like) }}&deg;</p>
        </div>
      </div>
    </div>
    ...
    <div class="bg-white/20 rounded-xl h-48 grid items-center">
      <div class="">
        ...
        <div class="text-center mt-3">
          ...
          <p class="text-white text-xl">{{ data.current.pressure }} hPa</p>
        </div>
      </div>
    </div>
    ...
    <div class="bg-white/20 rounded-xl h-48 grid items-center">
      <div class="">
        ...
        <div class="text-center mt-3">
          ...
          <p class="text-white text-xl">{{ data.current.humidity }}%</p>
        </div>
      </div>
    </div>
    ...
    <div class="bg-white/20 rounded-xl h-48 grid items-center">
      <div class="">
        ...
        <div class="text-center mt-3">
          ...
          <p class="text-white text-xl">{{ data.current.visibility / 1000 }} Km</p>
        </div>
      </div>
    </div>
    ...
    <div class="bg-white/20 rounded-xl h-48 grid items-center">
      <div class="">
        ...
        <div class="text-center mt-3">
          ...
          <p class="text-white text-xl">{{ Math.round(data.current.wind_speed * 3.6) }} Km/h</p>
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    getWeatherDescription(id) {
      const condition = this.conditions.find((cond) => cond.id === id)
